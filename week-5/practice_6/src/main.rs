fn main() {
    ...
    println!();
    println!("{} is aimeed at developing competent, creative, innovative, entrepreneurial and ethically-minded persons, capable of creative value int he diverse fields of Computer Science.",w3);
