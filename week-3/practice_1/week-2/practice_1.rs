fn main() {
    ...
    println!(
        "1. Distinguish between computer and computer programming,\n\
         2. Develop some techniques in computer science,\n\
         3. Understand the different areas of study in computer science,\n\
         4. Be conversant with applications of computer science,\n\
         5. Navigate the career prospects in computer science,\n\
         6. Be conversant with computer programming concepts."
    );
}